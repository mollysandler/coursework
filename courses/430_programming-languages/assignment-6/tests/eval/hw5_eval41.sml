            ...
            ("f3",
             TY_FUNC
               {in_types=[TY_BOOL],
                ret_type=TY_FUNC
                           {in_types=[],
                            ret_type=TY_FUNC {in_types=[],ret_type=TY_NONE}}}),
            ("f4",
             TY_FUNC
               {in_types=[],ret_type=TY_FUNC {in_types=[],ret_type=TY_NONE}}),
            ("f5",TY_FUNC {in_types=[],ret_type=TY_NONE})],
     func_decls=[("f",
                  {body=[ST_EXP
                           {exp=EXP_ASSIGN {lhs=EXP_ID "a",rhs=EXP_NUM 1}},
                         ST_RETURN
                           {exp=SOME
                                  (EXP_ANON
                                     {body=[ST_EXP
